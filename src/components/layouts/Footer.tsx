...
export default function Footer() {
  return (
    <footer id="contact" className="bg-[#3f3f3f] text-white pt-[1.8rem] px-[1.4rem] md:px-[max(2.4rem,calc(50%-600px))] pb-0 mt-[2rem]">
      <div className="footer__items flex flex-col md:flex-row md:items-center md:justify-between pb-8">

        {/* Logo */}
        <div className="footer__logo mb-[2.6rem] md:mb-0 text-center md:text-left md:w-[30%] md:min-w-[220px] flex justify-center">
          <Link href="/">
            <img
              src="/images/logo.png"
              alt="RoboISM Logo"
        ...
        {/* Links */}
        <div className="menu flex flex-col items-center md:items-start mb-8 md:mb-0">
          <ul className="menu__nav">
            {['Home', 'Achievements', 'About', 'Events', 'Alumni', 'Gallery'].map((item) => (
              <li className="menu__nav-item">
        ...
        {/* Contact Info */}
        <div className="contact flex flex-col items-center md:items-start text-center md:text-left">
          <h3 className="contact__heading font-heading text-[1.25rem] mb-4">Contact Us</h3>

          <div className="contact__contacts flex flex-col md:flex-row gap-4 md:gap-8 mb-6">
            <a
              href="mailto:robotics_club@iitism.ac.in"
              className="contact__email-contact flex items-center text-white no-underline hover:text-accent"
            >
            ...
            <a
              ...
              className="contact__location-contact flex items-center text-white no-underline hover:text-accent"
            >
              <FaMapMarkerAlt className="mr-2" /> IIT (ISM) Dhanbad
            </a>
          </div>

          <div className="contact__socials flex flex-row justify-center md:justify-start">
      ...
      <div className="copyright text-center font-heading text-[1.2rem] opacity-60 py-[0.6rem] border-t border-white/10">
        &copy; RoboISM {new Date().getFullYear()} &nbsp;&nbsp;&nbsp; | &nbsp;&nbsp;&nbsp; Made by RoboISM Members
      </div>
    </footer>
  );
