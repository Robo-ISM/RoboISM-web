...
export default function Home() {
  return (
    <>
      {/* Hero Section */}
      <section className="block block--hero block--2-column flex flex-row-reverse items-center justify-between px-4 py-20 min-h-screen md:flex-row-reverse md:py-0">
        <div className="block__image mx-auto mb-10 w-4/5 max-w-[280px] min-w-[240px] md:mx-0 md:mb-0 md:w-1/2 md:max-w-none">
          <Image
            src="/images/others/rendered1.png"
            alt="Rubik Cube Solver by RoboISM"
            width={600}
        ...
        <div className="content content--hero mb-10 md:mb-0">
          <h1 className="content__heading font-heading text-charcoal text-center text-[4.5rem] leading-[4.5rem] md:text-[7.2rem] md:leading-[6.8rem] md:tracking-[0.06rem] md:text-left">
            Robotics
            <br />
            &amp; AI Club
          </h1>
          <p className="content__sub-heading font-heading text-muted text-center text-[2.2rem] leading-[2.2rem] md:text-[3.7rem] md:leading-[4.4rem] md:text-left">
            IIT (ISM) Dhanbad
          </p>
          <Link
            href="#projects"
            className="button button--primary mx-auto mt-[2.2rem] md:mx-0 md:mt-[1.8rem] md:ml-[0.5rem] text-white"
          >
            Our Projects
          </Link>
        </div>
      ...
      <section className="block block--2-column flex flex-col items-center justify-center px-4 py-8 md:flex-row md:justify-between md:mb-[1.6rem]">
        ...
        <div className="content w-full md:w-[60%]">
          <h2 className="content__heading font-heading text-charcoal text-center text-[2.5rem] leading-[5rem] md:text-[3.2rem] md:tracking-[0.04rem] md:text-left">
            About Us
          </h2>
          <p className="content__content text-center text-muted text-[1.1rem] font-medium md:text-[1.25rem] md:text-left">
      ...
      {/* Achievements Teaser */}
      <section className="block content flex flex-col items-center px-4 py-8 md:mb-[1.6rem]">
        <h2 className="content__heading font-heading text-charcoal text-center text-[2.5rem] leading-[5rem] md:text-[3.2rem] md:tracking-[0.04rem]">
          Achievements
        </h2>
        <div className="content py-[0.4rem] pb-[0.8rem] w-full">
          {(achievements as Achievement[]).slice(0, 3).map((a, i) => (
            <div
              key={i}
              className="achievement-brief mb-[0.4em] p-4 bg-card-bg font-normal text-[1.25rem] text-center"
            >
              {a.brief}
            </div>
          ))}
      ...
      {/* Project Gallery Teaser */}
      <section className="block flex flex-col items-center px-4 py-8" id="projects">
        <div className="content content--with-bottommb-8 w-full">
          <h2 className="content__heading font-heading text-charcoal text-center text-[2.5rem] leading-[5rem] md:text-[3.2rem] md:tracking-[0.04rem]">
            Project Gallery
          </h2>
          <div className="content__content content__content--gallery flex flex-wrap items-center justify-center py-0 md:py-4">
            {["/images/others/Bot_4.jpeg", "/images/others/autonomousdronecrop.webp", "/images/others/7.jpg"].map(
              (src, i) => (
                <div
                  key={i}
